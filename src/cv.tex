...
%----------------------------------------------------------------------------------------
\section{Skills}
\cvitem{Computer skills}{Algorithms and Data Structures, \textsc{C++}, \textsc{Python}, \textsc{Java}, Linux, Microsoft Windows, SQL, Multithreaded synchronization, Git, Design patterns and refactoring.}
